            ...
            <Row>
              <Col md={6}>
                ...
                <p>
                  ...
                  operationalizing privacy policies into practice is nebulous
                  and challenging. How do you translate, measure, and test
                  values and high level aspirations into a user interface?
                  Second, there is a natural silo between industries fortifying
                  rare integration between industry, policy, and academic
                  research.
                </p>
                <p>
                  The first objective for this work was to explore intersections
                  of privacy policy and design through visual prototypes. The
                  second was to understand the challenges of translating policy
                  to platform changes based on the specific background and
                  industry skill set of the interviewees. Finally, we sought to
                  understand broader user perspectives of privacy and control on
                  social media.
                </p>
                <p>
                ...
                <p>
                  ...
                  insights for policymakers and industry practitioners working
                  in privacy-related spaces.
                </p>
              </Col>
              <Col md={6}>
            ...
            <Row className="justify-content-between">
              ...
              <Col md={6}>
                ...
                <p className="">
                  ...
                  based on our goals to represent a diversity of Senate teams,
                  to show a variety of different policy levers, and to produce
                ...
                <p className="">
                  ...
                  visualize how online platforms might change if these bills
                  were passed. Through lots of sketches and ideation sessions,
                  we produced a speculative visual prototype for each bill,
                  imagining what a social media platform might look like in
                  response to each bill. We chose to represent social media
                  platforms given their widespread reach and high engagement
                ...
                <p className="">
                  We conducted 41 one-on-one interviews to gather insights
                  around privacy and each of the individual bills. During the
                  interviews, we showed participants a summary of each bill,
                  visual examples to highlight the bill’s concepts, and our
                  visual prototype for the bill. We probed into their reactions
                  to the bills, aiming to identify what they saw as advantages
                  and challenges for each. We also talked about privacy more
                  broadly, asking participants how they viewed privacy both in
          ...
          <Layout footer>
            <Row>
              <Col md={6} className="learnings">
                ...
                <dl>
                  <dt>
                    Although we heard many similar definitions of privacy, the
                    way privacy is put into practice is shaped by the context.
                  </dt>
                  <dd>
                    The creation of a common language, or a set of phrases that
                    can be understood across all sectors may prove useful. Such
                    a lexicon could assist in identifying overlapping processes,
                    concern, interests, and harms, as well as enable better
                    collaborations between individuals from different sectors
                    and professions.
                  </dd>
                </dl>
                ...
                <dl>
                  ...
                  <dd>
                    ...
                    solution to ensure privacy protections. We heard from
                    several law experts that there is the need for a more
                    multi-layered approach to privacy, where several different
                    policies can work cooperatively.
                  </dd>
                </dl>
                ...
                <dl>
                  ...
                  <dd>
                    The design practitioners we interviewed noted a few methods
                    to improve privacy policy consent: just-in-time features to
                ...
                <CalloutCard flush title="What we heard">
                  <blockquote className="blockquote">
                    <p>
                      ...
                      assumption is that everything gets through at least one
                      part of the immune system--what you really want is enough
