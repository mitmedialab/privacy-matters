  ...
  [0],
  {
      ...
      function L(e) {
        for (var t = O(P); null !== t; ) {
          if (null === t.callback) A(P);
            ...
            A(P), (t.sortIndex = t.expirationTime), S(N, t);
          }
          t = O(P);
        }
      }
        ...
        try {
          for (
            ...
            if (null !== l) {
              ...
              (n = t.unstable_now()),
                "function" == typeof u ? (_.callback = u) : _ === O(N) && A(N),
                L(n);
            } else A(N);
            _ = O(N);
          }
            ...
            u > l
              ? ((e.sortIndex = u),
                ...
                null === O(N) &&
                  e === O(P) &&
                  (F ? a() : (F = !0), o(D, u - l)))
              : ((e.sortIndex = i), S(N, e), M || j || ((M = !0), r(U))),
            e
          );
        }),
      ...
      var r = n("k1TG"),
        ...
        p = function(e) {
          var t = e.className,
            ...
            s = "container";
          !0 === a ? (s = "container-fluid") : a && (s = "container-" + a);
    ...
    "2qpI": function(e, t, n) {
      ...
      var v,
        ...
        T = n("oCue"),
        x = n("1w3K"),
        k = Object(T.a)({}, x.Transition.propTypes, {
          isOpen: s.a.bool,
      ...
      var C = (function(e) {
        ...
        return (
          (n.onEntering = function(e, t) {
            this.setState({ height: A(e) }), this.props.onEntering(e, t);
          }),
          (n.onEntered = function(e, t) {
            this.setState({ height: null }), this.props.onEntered(e, t);
          }),
          (n.onExit = function(e) {
            this.setState({ height: A(e) }), this.props.onExit(e);
          }),
            ...
            return o.a.createElement(
              ...
              function(t) {
                var r = (function(e) {
                  ...
                  l = Object(d.j)(f()(a, r, u && "navbar-collapse"), s),
      ...
      (C.propTypes = k), (C.defaultProps = S);
      var N = C,
        P = n("9a8N"),
        R = n("F66N"),
        ...
        B = (function(e) {
          function t() {
            ...
            return (
              ...
              L()(I()(t), "referenceNode", void 0),
              L()(I()(t), "setReferenceNode", function(e) {
                e &&
                  t.referenceNode !== e &&
        ...
        G = [d.i.space, d.i.enter, d.i.up, d.i.down, d.i.end, d.i.home],
        W = (function(e) {
          function t(t) {
            var n;
            return (
            ...
            (n.render = function() {
              ...
              return (
                p && !h
                  ...
                  : h
                  ? (e = h)
                  : ((e = oe.a), (g.color = a), (g.cssModule = u)),
      ...
      var le = ie,
        ...
        me = (function(e) {
          function t() {
            ...
            return (
              (t = e.call.apply(e, [this].concat(r)) || this),
              L()(I()(t), "state", { data: void 0, placement: void 0 }),
              L()(I()(t), "popperInstance", void 0),
              L()(I()(t), "popperNode", null),
              L()(I()(t), "arrowNode", null),
              L()(I()(t), "setPopperNode", function(e) {
                e &&
                  t.popperNode !== e &&
              ...
              L()(I()(t), "setArrowNode", function(e) {
                t.arrowNode = e;
              }),
              L()(I()(t), "updateStateModifier", {
                enabled: !0,
                order: 900,
                fn: function(e) {
                  var n = e.placement;
    ...
    "7DDg": function(e, t, n) {
      ...
      if (n("nh4g")) {
        var r = n("LQAc"),
          ...
          Me = function(e, t) {
            return Ae(this, fe.call(Se(this), e, t));
          },
          Fe = function(e) {
            Se(this);
              ...
              ? ((h = n(function(e, n, r, o) {
                  ...
                  if (w(n)) {
                    ...
                    if (void 0 === o) {
                      ...
                      if ((i = y - p) < 0) throw H("Wrong length!");
                    } else if ((i = m(o) * t) + p > y) throw H("Wrong length!");
                    l = i / t;
                  } else (l = g(n)), (a = new $((i = l * t)));
                  for (
    ...
    "7Qtz": function(e, t, n) {
      ...
      function j(e, t, n) {
        ...
        for (
          (e = O(e)) != e || e === k
            ...
            : ((r = C(N(e) / P)),
              e * (a = A(2, -r)) < 1 && (r--, (a *= 2)),
              (e += r + s >= 1 ? c / a : c * A(2, 1 - s)) * a >= 2 &&
                (r++, (a /= 2)),
              r + s >= u
                ? ((o = 0), (r = u))
                : r + s >= 1
                ? ((o = (e * a - 1) * A(2, t)), (r += s))
                : ((o = e * A(2, s - 1) * A(2, t)), (r = 0)));
          t >= 8;
          i[f++] = 255 & o, o /= 256, t -= 8
        );
        for (
      ...
      function M(e, t, n) {
        ...
        if (0 === c) c = 1 - i;
          ...
          if (c === a) return r ? NaN : s ? -k : k;
          (r += A(2, t)), (c -= i);
        }
        return (s ? -1 : 1) * r * A(2, c - t);
      }
      function F(e) {
      ...
      function G(e, t, n, r, o, a) {
        var i = p(+n);
        if (i + t > e[_]) throw x(b);
        for (var l = e[R]._b, u = i + e[I], s = r(+o), c = 0; c < t; c++)
          l[u + c] = s[a ? c : t - c - 1];
      }
      if (i.ABV) {
        if (
        ...
        (E = function(e) {
          ...
          u(w[v], {
            ...
            getFloat32: function(e) {
              return M(H(this, 4, e, arguments[1]), 23, 4);
            },
            getFloat64: function(e) {
              return M(H(this, 8, e, arguments[1]), 52, 8);
            },
            setInt8: function(e, t) {
              G(this, 1, e, L, t);
            },
      ...
      function b(e) {
        return e.map(function(e) {
          ...
          return s.default.createElement(
            ...
            s.default.createElement("source", { media: o, srcSet: n, sizes: a })
          );
        });
      }
      function E(e) {
      ...
      var k = function(e, t) {
        ...
        O = function(e) {
          var t = e.src,
            ...
            r = e.generateSources,
            o = e.spreadProps,
            a = s.default.createElement(A, (0, u.default)({ src: t }, o));
          return n.length > 1
            ? s.default.createElement("picture", null, r(n), a)
            : a;
        },
        A = s.default.forwardRef(function(e, t) {
          var n = e.sizes,
            r = e.srcSet,
            o = e.src,
            a = e.style,
                ...
                this.addNoScript &&
                  s.default.createElement("noscript", {
                    dangerouslySetInnerHTML: {
                      __html: S(
                        (0, u.default)({ alt: n, title: t, loading: x }, F, {
                          imageVariants: M
                        })
                      )
                    }
      ...
      var r = n("k1TG"),
        ...
        p = function(e) {
          var t = e.className,
            ...
            s = Object(f.j)(c()(t, "nav-item", !!a && "active"), n);
          return i.a.createElement(l, Object(r.a)({}, u, { className: s }));
        };
    ...
    Z0PK: function(e) {
      e.exports = JSON.parse(
        '{"data":{"markdownRemark":{"frontmatter":{"title":"Social Media Addiction Reduction Technology (SMART) Act","subtitle":"Bans dark patterns + addictive features and raises user awareness on social media ","date":"July 30, 2019","by":"Senator Josh Hawley (R-Mo.)","byUri":"https://www.hawley.senate.gov/"}}}}'
      );
    },
    "Z6+o": function(e, t) {
      e.exports = function(e) {
    ...
    kQFn: function(e) {
      e.exports = JSON.parse(
        '{"data":{"markdownRemark":{"frontmatter":{"title":"About CORPA","subtitle":"Codifies privacy as a right and creates a private right of action to enforce privacy rights and oversight of platforms","date":"November 18, 2019","by":"U.S. Senate Committee on Commerce, Science, and Transportation Ranking Member Maria Cantwell (D-WA) and fellow senior members Senators Brian Schatz (D-HI), Amy Klobuchar (D-MN), and Ed Markey (D-MA)","byUri":"https://www.hawley.senate.gov/"}}}}'
      );
    },
    kTM6: function(e, t, n) {
      "use strict";
          ...
          return (
            ...
            (t.prototype.render = function() {
              var e = this.props,
                ...
                n = e.cssModule,
                r = e.tag,
                a = Object(b.k)(this.props, Object.keys(E)),
      ...
      (S.propTypes = k), (S.defaultProps = { tag: "div" });
      var O = n("Wbzz"),
        A = n("Z0PK"),
        C = (n("KKXr"), n("ok1R")),
        N = n("rhny"),
        ...
        j = function(e) {
          ...
          return o.a.createElement(
            ...
            o.a.createElement(
              N.a,
              { md: "8" },
              o.a.createElement("h1", { className: "py-2" }, n),
              o.a.createElement(
                "div",
                { className: "d-block d-md-none bill-image-inline mx-auto" },
                o.a.createElement(I, null)
              ),
              o.a.createElement("div", { className: "py-4 subheading-1" }, r),
        ...
        M = function(e) {
          var t = A.data.markdownRemark;
          return o.a.createElement(j, { markdownRemark: t });
        },
        F = n("obf7"),
        L = function(e) {
          var t = F.data.markdownRemark;
          return o.a.createElement(j, { markdownRemark: t });
        },
        D = n("kQFn"),
        U = function(e) {
        ...
        B =
          ...
          function(e) {
            var t,
              n = e.policy,
              r =
                (((t = {})[z.c] = o.a.createElement(M, null)),
                (t[z.b] = o.a.createElement(L, null)),
                (t[z.a] = o.a.createElement(U, null)),
                t);
            return o.a.createElement(
              o.a.Fragment,
              null,
                ...
                o.a.createElement(
                  ...
                  o.a.createElement(
                    ...
                    o.a.createElement(
                      O.Link,
                      {
                        className: "nav-link " + (n === z.c ? "active" : ""),
                  ...
                  o.a.createElement(
                    ...
                    o.a.createElement(
                      O.Link,
                      {
                        className: "nav-link " + (n === z.b ? "active" : ""),
                        to: "/bill-opa/?ft=" + i.a
                      },
                      "OPA"
                    )
                  ...
                  o.a.createElement(
                    ...
                    o.a.createElement(
                      O.Link,
                      {
                        className: "nav-link " + (n === z.a ? "active" : ""),
        ...
        H = n("ChEw"),
        G = n("sOKU"),
        W = (n("pIFo"), n("Tze0"), n("Oyvg"), n("2Spj"), n("oCue")),
        q = n("uRdJ"),
        $ = n("i8i4"),
        K = n.n($),
      ...
      function te(e) {
        var t = e.tag,
          ...
          c = Object(b.l)(s, b.a),
          d = Object(b.k)(s, b.a);
        return o.a.createElement(J.Transition, c, function(e) {
          var s = "entered" === e,
            c = Object(b.j)(y()(a, n, s && r), i);
          return o.a.createElement(
            t,
            Object(f.a)({ className: c }, d, { ref: u }),
            l
          );
        });
      }
      (te.propTypes = Z), (te.defaultProps = ee);
      var ne = te;
      function re() {}
      var oe = m.a.shape(ne.propTypes),
        ae = {
          isOpen: m.a.bool,
          autoFocus: m.a.bool,
          centered: m.a.bool,
          ...
          modalTransition: oe,
          innerRef: m.a.oneOfType([m.a.object, m.a.string, m.a.func]),
          unmountOnClose: m.a.bool,
          returnFocusAfterClose: m.a.bool
        },
        ie = Object.keys(ae),
        le = {
          isOpen: !1,
        ...
        ue = (function(e) {
          function t(t) {
            ...
            return (
              ...
              (n.handleEscape = n.handleEscape.bind(Object(q.a)(n))),
              (n.handleStaticBackdropAnimation = n.handleStaticBackdropAnimation.bind(
                Object(q.a)(n)
              )),
              (n.handleTab = n.handleTab.bind(Object(q.a)(n))),
              (n.onOpened = n.onOpened.bind(Object(q.a)(n))),
              (n.onClosed = n.onClosed.bind(Object(q.a)(n))),
          ...
          return (
            ...
            (n.onOpened = function(e, t) {
              this.props.onOpened(),
                (this.props.modalTransition.onEntered || re)(e, t);
            }),
            (n.onClosed = function(e) {
              var t = this.props.unmountOnClose;
              this.props.onClosed(),
                (this.props.modalTransition.onExited || re)(e),
                t && this.destroy(),
                this.close(),
            ...
            (n.getFocusableChildren = function() {
              return this._element.querySelectorAll(b.f.join(", "));
            }),
            ...
            (n.init = function() {
              ...
              this._element ||
                ...
                (this._originalBodyPadding = Object(b.g)()),
                Object(b.e)(),
                0 === t.openCount &&
                  (document.body.className = y()(
                    document.body.className,
                    Object(b.j)("modal-open", this.props.cssModule)
                  )),
                (t.openCount += 1);
            }),
            (n.destroy = function() {
            ...
            (n.close = function() {
              ...
              this.manageFocusAfterClose(),
                ...
                Object(b.m)(this._originalBodyPadding);
            }),
            (n.renderModalDialog = function() {
              var e,
                t = this,
                n = Object(b.k)(this.props, ie);
              return o.a.createElement(
                "div",
                Object(f.a)({}, n, {
                  className: Object(b.j)(
                    y()(
                      "modal-dialog",
                ...
                o.a.createElement(
                  ...
                  {
                    className: Object(b.j)(
                      y()("modal-content", this.props.contentClassName),
                      this.props.cssModule
                    )
                  },
                  this.props.children
                    ...
                    (g
                      ? o.a.createElement(
                          ...
                          Object(f.a)({}, E, {
                            in: u && !!s,
                            cssModule: l,
                            className: Object(b.j)(y()("modal-backdrop", i), l)
                          })
                        )
                      : o.a.createElement("div", {
                          className: Object(b.j)(
                            y()("modal-backdrop", "show", i),
                            l
                          )
                        }));
                return o.a.createElement(
      ...
      (ue.propTypes = ae), (ue.defaultProps = le), (ue.openCount = 0);
      var se = ue,
        ce = {
          tag: b.n,
          wrapTag: b.n,
          ...
          cssModule: m.a.object,
          children: m.a.node,
          closeAriaLabel: m.a.string,
          charCode: m.a.oneOfType([m.a.string, m.a.number]),
          close: m.a.object
        },
        fe = function(e) {
          var t,
            ...
            h = Object(b.j)(y()(n, "modal-header"), r);
          if (!d && i) {
            var m = "number" == typeof c ? String.fromCharCode(c) : c;
            t = o.a.createElement(
              "button",
              {
                type: "button",
                onClick: i,
                className: Object(b.j)("close", r),
                "aria-label": s
              },
          ...
          return o.a.createElement(
            u,
            Object(f.a)({}, p, { className: h }),
            o.a.createElement(
              l,
              { className: Object(b.j)("modal-title", r) },
              a
            ),
            d || t
          );
      ...
      var de = fe,
        pe = { tag: b.n, className: m.a.string, cssModule: m.a.object },
        he = function(e) {
          var t = e.className,
            n = e.cssModule,
            r = e.tag,
            a = Object(x.a)(e, ["className", "cssModule", "tag"]),
            i = Object(b.j)(y()(t, "modal-body"), n);
          return o.a.createElement(r, Object(f.a)({}, a, { className: i }));
        };
      (he.propTypes = pe), (he.defaultProps = { tag: "div" });
      var me = he,
        ge = n("qN1e"),
        ye = function() {
          var e = ge.data;
        ...
        Te =
          ...
          function(e) {
            var t,
              n = e.selectedPolicy,
              a =
                (((t = {})[z.c] = o.a.createElement(ye, null)),
                (t[z.b] = o.a.createElement(be, null)),
                (t[z.a] = o.a.createElement(we, null)),
                t),
            ...
            return o.a.createElement(
              ...
              o.a.createElement(
                ...
                o.a.createElement(
                  G.a,
                  { color: "primary", className: "my-2", onClick: s },
                  "View"
                ),
                o.a.createElement(
                  se,
        ...
        Se = function(e) {
          var t = xe.data.markdownRemark;
          return o.a.createElement(ke, { markdownRemark: t });
        },
        Oe = n("BPGI"),
        Ae = function(e) {
          ...
          function(e) {
            ...
            return o.a.createElement(
              ...
              o.a.createElement(
                ...
                o.a.createElement(
                  "blockquote",
                  { className: "blockquote subheading-1" },
                  o.a.createElement("div", {
            ...
            return o.a.createElement(
              ...
              o.a.createElement(
                ...
                o.a.createElement(
                  ...
                  o.a.createElement(Ie, { selectedPolicy: t })
                )
              )
            );
          });
      t.a = function(e) {
        ...
        return Object(i.b)(i.a)
          ? o.a.createElement(
              ...
              o.a.createElement(B, { policy: t }),
              o.a.createElement(a.a, null, o.a.createElement(je, { policy: t }))
            )
          : o.a.createElement(
              o.a.Fragment,
              null,
    ...
    obf7: function(e) {
      e.exports = JSON.parse(
        '{"data":{"markdownRemark":{"frontmatter":{"title":"Online Privacy Act (OPA)","subtitle":"Creates user data rights and strengthens enforcement with a Digital Privacy Agency and state level attorneys","date":"November 5, 2019","by":"Congresswoman Anna G. Eshoo (CA-18) and Zoe Lofgren (CA-19)","byUri":"https://www.hawley.senate.gov/"}}}}'
      );
    },
    ok1R: function(e, t, n) {
      "use strict";
      ...
      var r = n("k1TG"),
        ...
        m = function(e) {
          ...
          var h = Object(f.j)(
            c()(t, a ? "no-gutters" : null, u ? "form-row" : "row", p),
            n
          );
        ...
        var s,
          ...
          x = function(e, t) {
            var n = e.baseTag,
              ...
              d = e.title,
              p = e.titleAttributes;
            O(l.TAG_NAMES.BODY, r), O(l.TAG_NAMES.HTML, o), S(d, p);
            var h = {
    ...
    yl30: function(e, t, n) {
      ...
      var j = /^(.*)[\\\/]/,
        ...
        G = M ? Symbol.for("react.forward_ref") : 60112,
      ...
      function xn(e) {
        ...
        for (n = 0; n < e.ancestors.length; n++) {
          ...
          for (
            ...
            var s = f[u];
            s && (s = s.extractEvents(r, t, a, o, i)) && (l = O(l, s));
          }
          P(l);
        }
      }
          ...
          extractEvents: function(e, t, n, r) {
            ...
            return (
              a
                ? (Or &&
                    "ko" !== n.locale &&
                    (_r || a !== Cr.compositionStart
                      ? a === Cr.compositionEnd && _r && (o = br())
        ...
        return uo || null == ao || ao !== Wn(n)
          ...
          : ("selectionStart" in (n = ao) && Yn(n)
            ...
            lo && no(lo, n)
              ? null
              : ((lo = n),
                ((e = Mt.getPooled(oo.select, io, e, t)).type = "select"),
                (e.target = ao),
                _t(e),
                e));
      }
      ...
      function Qo(e) {
        return null === Vo ? ((Vo = [e]), (Ho = No(Mo, Zo))) : Vo.push(e), zo;
      }
      function Jo() {
        if (null !== Ho) {
          var e = Ho;
        ...
        return (
          "object" == typeof a && null !== a
            ...
            : ((o = wo(t) ? bo : yo.current),
              (a = (r = null != (r = t.contextTypes)) ? Eo(e, o) : go)),
          (t = new t(n, a)),
          (e.memoizedState =
      ...
      function _a(e, t, n, r) {
        ...
        "object" == typeof a && null !== a
          ? (o.context = da(a))
          : ((a = wo(t) ? bo : yo.current), (o.context = Eo(e, a))),
      ...
      function Fa(e) {
        ...
        function s(e, t, n, r) {
          return null !== t && t.elementType === n.type
            ? (((r = o(t, n.props)).ref = ja(e, t, n)), (r.return = e), r)
            : (((r = Yu(n.type, n.key, n.props, null, e.mode, r)).ref = ja(
                e,
                t,
                n
              )),
        ...
        function d(e, t, n) {
          ...
          if ("object" == typeof t && null !== t) {
            switch (t.$$typeof) {
              case F:
                return (
                  ((n = Yu(t.type, t.key, t.props, null, e.mode, n)).ref = ja(
                    e,
                    null,
                    t
                  )),
        ...
        return function(e, r, a, u) {
              ...
              case F:
                e: {
                  for (c = a.key, s = r; null !== s; ) {
                    if (s.key === c) {
                      if (
                        7 === s.tag ? a.type === D : s.elementType === a.type
                      ) {
                        n(e, s.sibling),
                          ((r = o(
                            s,
          ...
          if (X(a)) return g(e, r, a, u);
          if ((c && Ma(e, a), void 0 === a && !s))
            switch (e.tag) {
              case 1:
              case 0:
                throw ((e = e.type),
      ...
      function bi(e) {
        ...
        if (
          ...
          do {
            ...
            f < Za
              ? (c || ((c = !0), (u = l), (o = a)), f > ii && Cu((ii = f)))
              : (Au(f, s.suspenseConfig),
      ...
      function Vi(e) {
        ...
        } else Fi = Mi ? ir(e.stateNode.nextSibling) : null;
        return !0;
      }
      function Hi() {
        (Fi = Mi = null), (Li = !1);
      }
      var Gi = I.ReactCurrentOwner,
        Wi = !1;
      function qi(e, t, n, r) {
        t.child = null === e ? Da(t, null, n, r) : La(t, e.child, n, r);
      }
        ...
        if ((fa(t, o), null === t.stateNode))
          ...
          (i = t.stateNode),
            ...
            l !== r || u !== d || vo.current || pa
              ? ("function" == typeof c &&
                  (Aa(t, n, c, r), (d = t.memoizedState)),
                (c = pa || Na(t, n, l, r, u, d, s))
                  ? (f ||
      ...
      function Zi(e, t, n, r, o, a) {
        ...
        if (!r && !i) return o && Ao(t, n, !1), cl(e, t, a);
        ...
        return (
          (t.effectTag |= 1),
          null !== e && i
            ? ((t.child = La(t, e.child, null, a)),
              (t.child = La(t, null, l, a)))
            : qi(e, t, l, a),
      ...
      function sl(e, t, n) {
        var r = t.pendingProps,
          o = r.revealOrder,
          a = r.tail;
        if ((qi(e, t, r.children, n), 0 != (2 & (r = Ka.current))))
      ...
      function yu(e, t) {
        ...
        return (
          null !== o && (Wl === o && (Cu(t), Kl === Vl && ts(o, $l)), ns(o, t)),
          o
        );
      }
      function vu(e) {
      ...
      function Eu(e, t) {
        ...
        var n = vu(e);
        if (0 !== n) {
          if (((t = e.callbackNode), (Gl & (Fl | Ll)) !== jl))
            throw Error(i(327));
          if ((Lu(), (e === Wl && n === $l) || ku(e, n), null !== ql)) {
            var r = Gl;
            Gl |= Fl;
            for (var o = Ou(); ; )
              try {
            ...
            if ((la(), (Gl = r), (_l.current = o), Kl === Ul))
              throw ((t = Yl), ku(e, n), ts(e, n), bu(e), t);
            if (null === ql)
              switch (
                ...
                case Hl:
                  if (1073741823 !== Xl && null !== Jl) {
                    ...
                    if (
                      ...
                      ts(e, n), (e.timeoutHandle = or(ju.bind(null, e), r));
                      break;
                    }
                  }
                  ju(e);
      ...
      function wu(e) {
        ...
        if (((t = 0 !== t ? t : 1073741823), e.finishedExpirationTime === t))
          ...
          if ((Gl & (Fl | Ll)) !== jl) throw Error(i(327));
          if ((Lu(), (e === Wl && t === $l) || ku(e, t), null !== ql)) {
            var n = Gl;
            Gl |= Fl;
            for (var r = Ou(); ; )
              try {
            ...
            if ((la(), (Gl = n), (_l.current = r), Kl === Ul))
              throw ((n = Yl), ku(e, t), ts(e, t), bu(e), n);
      ...
      function Ou() {
        var e = _l.current;
        return (_l.current = _i), null === e ? _i : e;
      }
      function Au(e, t) {
        e < Xl && 2 < e && (Xl = e),
      ...
      function _u(e) {
        ...
        do {
          ...
          if (((e = ql.return), 0 == (2048 & ql.effectTag))) {
                    ...
                    if (Vi(t)) {
                      ...
                      switch (
                        ...
                        case "details":
                          ...
                          break;
                        case "input":
                          Ae(r, c), Sn("invalid", r), Hn(f, "onChange");
                          break;
                        case "select":
                          ...
                          break;
                        case "textarea":
                          Me(r, c), Sn("invalid", r), Hn(f, "onChange");
                      }
            ...
            if (((a = ql), 1 === $l || 1 !== a.childExpirationTime)) {
      ...
      function Mu(e, t) {
        ...
        if (
          ...
          (tr = { focusedElem: l, selectionRange: u }), (kn = !1), (ru = o);
          do {
            try {
              Fu();
            } catch (M) {
              if (null === ru) throw Error(i(330));
              zu(ru, M), (ru = ru.nextEffect);
            }
          } while (null !== ru);
          ru = o;
          do {
      ...
      function Du() {
        if (null === uu) return !1;
        var e = uu;
        if (((uu = null), (Gl & (Fl | Ll)) !== jl)) throw Error(i(331));
        var t = Gl;
        for (Gl |= Ll, e = e.current.firstEffect; null !== e; ) {
          try {
            var n = e;
      ...
      function Bu(e, t, n) {
        ...
        null !== r && r.delete(t),
          Wl === e && $l === n
            ? Kl === Vl || (Kl === Bl && 1073741823 === Xl && qo() - tu < nu)
              ? ku(e, $l)
              : (eu = !0)
            : es(e, n) &&
        ...
        switch (((t.expirationTime = 0), t.tag)) {
          ...
          case 11:
            return (
              (r = t.type),
              (o = t.pendingProps),
              $i(e, t, r, (o = t.elementType === r ? o : na(r, o)), n)
            );
          case 7:
      ...
      var ds,
        ...
        hs = {
          ...
          flushSync: function(e, t) {
            if ((Gl & (Fl | Ll)) !== jl) throw Error(i(187));
            var n = Gl;
            Gl |= 1;
            try {
...
//# sourceMappingURL=commons-e9d1090397e341077e1f.js.map
