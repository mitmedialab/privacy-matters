        ...
        try {
          return (function e(t, n) {
            ...
            if (t && n && "object" == typeof t && "object" == typeof n) {
              ...
              if (A != T) return !1;
              if (A && T) return t.toString() == n.toString();
              var y = a(t);
              if ((u = y.length) !== a(n).length) return !1;
              for (c = u; 0 != c--; ) if (!o.call(n, y[c])) return !1;
              if (i && t instanceof Element && n instanceof Element)
                return t === n;
              for (c = u; 0 != c--; )
                if (!(("_owner" === (s = y[c]) && t.$$typeof) || e(t[s], n[s])))
                  return !1;
              return !0;
            }
            return t != t && n != n;
          ...
          S = function(e, t) {
            ...
            Object.keys(A).forEach(function(e) {
              var t = A[e],
                n = t.newTags,
                r = t.oldTags;
              n.length && (T[e] = n), r.length && (y[e] = A[e].oldTags);
            }),
              t && t(),
              s(e, T, y);
          },
        ...
        (t.convertReactPropstoHtmlAttributes = function(e) {
          ...
          (t.reducePropsToState = function(e) {
            return {
              ...
              styleTags: T(c.TAG_NAMES.STYLE, [c.TAG_PROPERTIES.CSS_TEXT], e),
              title: f(e),
...
//# sourceMappingURL=component---src-pages-index-js-85fa7a8376a4abde0f89.js.map
